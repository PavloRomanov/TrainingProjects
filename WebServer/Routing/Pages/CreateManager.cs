...
namespace Routing.Pages
{
    public class CreateManager : BasePage
    {
        ...
        {
            HtmlForm htmlForm = new HtmlForm(MethodsRequest.RequestMethod.POST, "CreateManager", errors);
            ...
            if (errors != null && errors.Count > 0)
            {
                ...
                htmlForm.AddTag("br");
                htmlForm.AddTag(new HtmlInput(TypeInputcs.InputType.Text, "name", form["name"]))
                ...
                htmlForm.AddTag("br");
                htmlForm.AddTag(new HtmlInput(TypeInputcs.InputType.Text, "surname", form["surname"]))
                 .SetAttribut("maxlength", "15")
                    .SetAttribut("placeholder", "max length of 15 characters")
                    .SetAttribut("required", "required");
                if (errors.ContainsKey("name"))
                ...
                htmlForm.AddTag("br");
                htmlForm.AddTag(new HtmlInput(TypeInputcs.InputType.Text, "address", form["address"]))
                ...
                htmlForm.AddTag("br");
                htmlForm.AddTag(new HtmlInput(TypeInputcs.InputType.Text, "phone", form["phone"]))
                ...
                htmlForm.AddTag("br");
                htmlForm.AddTag(new HtmlInput(TypeInputcs.InputType.Text, "login", form["login"]))
                ...
                htmlForm.AddTag("br");
                htmlForm.AddTag(new HtmlInput(TypeInputcs.InputType.Password, "password", form["password"]))
            ...
            else
            {
                ...
                htmlForm.AddTag("lable", "Login: ");
                htmlForm.AddTag("br");
                htmlForm.AddTag(new HtmlInput(TypeInputcs.InputType.Text, "login", ""))
                    .SetAttribut("maxlength", "15")
                    .SetAttribut("placeholder", "max length of 15 characters")
                    .SetAttribut("required", "required");
                ...
                htmlForm.AddTag("lable", "Password: ");
                htmlForm.AddTag("br");
                htmlForm.AddTag(new HtmlInput(TypeInputcs.InputType.Password, "password", ""))
                    .SetAttribut("maxlength", "15")
                    .SetAttribut("placeholder", "max length of 15 characters")
                    .SetAttribut("required", "required");
                htmlForm.AddTag("span").SetAttribut("id", "s6");
                ...
                htmlForm.AddTag("br");
                htmlForm.AddTag(new HtmlInput(TypeInputcs.InputType.Reset, "Reset", "Clin"));
                htmlForm.AddTag(new HtmlInput(TypeInputcs.InputType.Submit, "Submit", "Submit")).SetAttribut("onclick", "FormIsValidManager()");
            }
